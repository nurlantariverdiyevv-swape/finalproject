    ...
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-full sm:w-[420px] bg-white z-[120] shadow-2xl transition-transform duration-300 transform overflow-y-auto ${open ? "translate-x-0" : "translate-x-full"}`}>
        <div className="flex items-center justify-between px-6 py-6 border-b border-gray-100 sticky top-0 bg-white z-10">
          ...
          <button type="button" onClick={onClose} className="p-1 hover:opacity-70 cursor-pointer" aria-label="Close">
  ...
  return (
    <>
      <div className="pt-2 border-t border-gray-200 text-sm">
        <button type="button" onClick={() => setActiveDrawer("returns")} className="w-full py-3 flex items-center justify-between border-b border-gray-200 hover:bg-gray-50 text-left cursor-pointer">
        ...
        <button type="button" onClick={() => setActiveDrawer("shipping")} className="w-full py-3 flex items-center justify-between border-b border-gray-200 hover:bg-gray-50 text-left cursor-pointer">
        ...
        <button type="button" onClick={() => setActiveDrawer("store")} className="w-full py-3 flex items-center justify-between border-b border-gray-200 hover:bg-gray-50 text-left cursor-pointer">
